...
bool Graphics::InitializeDirectX(HWND hwnd, int width, int height)
{
	...
	COM_HRESULT_IF_FAILED(hr, "Failed to create device and swapchain.");

	Microsoft::WRL::ComPtr<ID3D11Texture2D> backBuffer;
	hr = this->swapchain->GetBuffer(0, __uuidof(ID3D11Texture2D), reinterpret_cast<void**>(backBuffer.GetAddressOf()));
	COM_HRESULT_IF_FAILED(hr, "GetBuffer Failed.");

	hr = this->device->CreateRenderTargetView(backBuffer.Get(), NULL, this->renderTargetView.GetAddressOf());
	COM_HRESULT_IF_FAILED(hr, "Failed to create render target view.");
	...
	COM_HRESULT_IF_FAILED(hr, "Failed to create depth stencil buffer.");

	hr = this->device->CreateDepthStencilView(this->depthStencilBuffer.Get(), NULL, this->depthStencilView.GetAddressOf());
	COM_HRESULT_IF_FAILED(hr, "Failed to create depth stencil view.");
	...
	COM_HRESULT_IF_FAILED(hr, "Failed to create depth stencil state.");
	...
	COM_HRESULT_IF_FAILED(hr, "Failed to create rasterizer state.");
	...
	COM_HRESULT_IF_FAILED(hr, "Failed to create blend state.");
	...
	COM_HRESULT_IF_FAILED(hr, "Failed to create sampler state.");
