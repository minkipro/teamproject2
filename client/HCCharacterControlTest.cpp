...
void HCCharacterControlTest::Init()
{
	...
	auto charMoveUp = [this](void* character, float deltaTime)->void
	{
		...
		static_cast<HC2DCharacter*>(character)->SetAnimation(&m_animations[ANI_UP]);
	...
	auto charMoveLeft = [this](void* character, float deltaTime)->void
	{
		...
		static_cast<HC2DCharacter*>(character)->SetAnimation(&m_animations[ANI_LEFT]);
		static_cast<HC2DCharacter*>(character)->AddPos(pos);
	};
	...
	{
		DirectX::XMFLOAT2 pos = { 0.0f, 200.0f * deltaTime };
		static_cast<HC2DCharacter*>(character)->SetAnimation(&m_animations[ANI_DOWN]);
		static_cast<HC2DCharacter*>(character)->AddPos(pos);
	};
	...
	{
		DirectX::XMFLOAT2 pos = { 200.0f * deltaTime, 0.0f };
		static_cast<HC2DCharacter*>(character)->SetAnimation(&m_animations[ANI_RIGHT]);
		static_cast<HC2DCharacter*>(character)->AddPos(pos);
	};
